...
//   if ($("#btn-desktop-download").css("display") != "none") {
//     cposition = "bottom";
//     cstat = false;
//   } else if ($("#btn-desktop-download").css("display") == null) {
//     console.log("prazdna var pro cookies");
//   } else {
//     cposition = "top";
//     cstat = true;
//   }
...
$(document).ready(function () {
  ...
  console.log(sdetect + " = sdetect");
  if (
    sdetect == "#ffffff" ||
    sdetect == "rgb(255, 255, 255)" ||
    sdetect == "white"
  ) {
    devicesize = "desktop";
  } else {
  ...
  if (devicesize === "mobile") {
    ...
    if (useros === "Mac OS") {
      ...
      $(".display-desktop").removeClass("hidden");
...
$(document).ready(function () {
  ...
  if (
    currenturl.indexOf("https://bibinoapp.com/download/") > -1 ||
    currenturl.indexOf("http://bibinoapp.com/download/") > -1 ||
    currenturl.indexOf("http://localhost:8000/download/") > -1 ||
    currenturl === "http://localhost:8000/download" ||
    currenturl === "http://bibinoapp.com/download" ||
    currenturl === "https://bibinoapp.com/download"
  ) {
    setUtmCookies();
    let location = "BibinoDownloadPage";
    var source;
  ...
  if (
    currenturl.indexOf("https://bibinoapp.com/?utm_source") > -1 ||
    currenturl.indexOf("http://bibinoapp.com/cs?utm_source") > -1 ||
    currenturl.indexOf("https://bibinoapp.com/cs?utm_source") > -1 ||
    currenturl.indexOf("http://bibinoapp.com/?utm_source") > -1 ||
    currenturl.indexOf("http://localhost:8000/?utm_source") > -1 ||
    currenturl.indexOf("http://localhost:8000/cs?utm_source") > -1
  ) {
    setUtmCookies();
    let location = "BibinoWeb";
    var source;
    if (utmSource === "separation_anxiety_web") {
      source = "Outside";
      generateUtmUrl("GPlay", location, source);
...
$(window).scroll(function () {
  var element = document.getElementById("pic-sleeping-baby");
  //check jestli #pic-sleeping-baby existuje
  if (typeof element != "undefined" && element != null) {
    var hT = $("#pic-sleeping-baby").offset().top,
      hH = $("#pic-sleeping-baby").outerHeight(),
      wH = $(window).height(),
      wS = $(this).scrollTop();
    ...
    if (wS > hT + hH - wH && shown === false) {
      ...
      setTimeout(function () {
        $("#menu-try").css({ opacity: "1", transitiion: "all 0.3s" });
      }, 1);
...
// });
$(document).ready(function () {
  if (window.location.href == "https://bibinoapp.com/en") {
    $("link[rel='canonical']").attr({ href: "https://bibinoapp.com/en" });
